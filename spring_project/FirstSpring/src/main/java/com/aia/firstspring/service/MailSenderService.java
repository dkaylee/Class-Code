...
public class MailSenderService {
	...
	public boolean simpleMailSend() {
		...
		message.setTo("dkayleeee3@gmail.com");
	...
	public boolean mailSend(String toEmailAddress) {
		...
		try {
			...
			message.setFrom(new InternetAddress("dkayleeee3@gmail.com"));
			// 받는 사람의 이메일 주소
			message.addRecipient(RecipientType.TO, new InternetAddress(toEmailAddress, "dk 고객님", "utf-8"));
			// 메일 전송
			mailSender.send(message);
