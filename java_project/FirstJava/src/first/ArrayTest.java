...
public class ArrayTest {
	...
	public static void main(String[] args) {
		...
		//배열의 참조: 입력, 읽기
		//배열이름[index] : 배열의 변수는 순차적으로 위치하기 때문에 index 값으로 참조한다.
		...
		int [] ref;
		ref = addAllArray(arr4, 7); // addAllArray(0X100,7) => 0X100, ref
		if(arr4==ref) {
		...
		// 로또 번호 축출 프로그램
		// 정수 데이터 1~45까지 숫자를 저장하느 ㄴ변수 45개 생성 -> int 타입의 배열 선언 생성
		int[] ball = new int[45];
...
//		}
		// 각 index의 값들을 섞는 처리 : index=0의 값과 임의의(1~44) index 값을 서로 바꾼다.	
