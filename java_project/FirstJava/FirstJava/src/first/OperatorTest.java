...
public class OperatorTest {
	public static void main(String[] args) {
		...
		System.out.println("10/8f = " + 10f / 8f);
		...
		System.out.println("'A' < 'B' => " + (c1 < c2)); // 65 < 66 변경 처리
		System.out.println("'0' == 0 => " + ('0' == 0)); // '0' -> unicode 값을 갖기때문에

		System.out.println("10.0d == 10.0f => " + (10.0d == 10.0f)); // 10.0d => 10.0d로 바뀐다.
		...
		// 메서드로 3.14
		float sPi2 = Math.round(pi * 100) / 100f; // Math메서드는 integer값으로 반환됨
		...
		str = "abc"; // "" -> 공백문자를 이용한 객체를 생성하고 주소값을 반환
		...
		//삼항 연산자 이용
		//big = num1 > num2 ? num1 : num2;  // big = num1 대입되는 연산
