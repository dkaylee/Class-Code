...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    // 2. 업로드 할 파일을 보관 fileItem의 Factory 객체를 설정
   	DiskFileItemFactory factory = new DiskFileItemFactory();
    
    // 3. 요청을 처리(form 안의 input 들을 분)할 ServletFileUpload 생성
    ...
    Iterator<FileItem> itr = items.iterator();
     ...
     while(itr.hasNext()) {
    	...
    	if(item.isFormField()){
    		...
    		System.out.println("필드이름: "+fName);
    		System.out.println("파일이름: "+userFileName);
    		...
    		if(!userFileName.isEmpty() && fileSize>0){
    			...
    			// java의 경로를 만들어줌 저장할 경로를 File 객체로 생성
